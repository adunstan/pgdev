...
INSERT INTO test1 SELECT generate_series(1, 10000);""")
    ...
    primary.safe_sql(
        f"SELECT pg_relation_size('test1')::int / {blocksize} - 1;")
    relfilenode = primary.safe_sql(
    ...
    for line in res.stdout.split("\n"):
        ...
        if m:
            ...
            break
    assert offline_recovery_lsn is not None, \
        "No minRecoveryPoint in control file found"
