...
# Opaque handles and scalar aliases.  The names mirror libpq's PGconn */
# PGresult * typedefs, hence the non-PascalCase spelling.
PGconn_p = c_void_p  # pylint: disable=invalid-name
PGresult_p = c_void_p  # pylint: disable=invalid-name
Oid = c_uint
