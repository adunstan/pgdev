...
def _system_lib_paths():
    ...
    # Honor the loader's search path first, so a libpq placed on
    # LD_LIBRARY_PATH / DYLD_LIBRARY_PATH wins over a system-installed one,
    # matching how the dynamic linker resolves the library.
