...
def test_004_sync(create_pg):
    ...
    node_publisher.safe_sql("INSERT INTO tab_rep SELECT generate_series(11,20)")
    ...
    assert result == "0", "no data for table added after subscription initialized"
    ...
    # Add some data
    node_publisher.safe_sql("INSERT INTO tab_rep_next SELECT generate_series(1,10)")
