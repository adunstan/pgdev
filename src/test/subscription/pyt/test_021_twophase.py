...
def test_021_twophase(create_pg):
    ...
    node_publisher.safe_sql("CREATE PUBLICATION tap_pub FOR TABLE tab_full")
    ...
    result = node_subscriber.safe_sql("SELECT count(*) FROM pg_prepared_xacts;")
    ...
    result = node_subscriber.safe_sql("SELECT count(*) FROM tab_full where a = 11;")
    ...
    result = node_subscriber.safe_sql("SELECT count(*) FROM tab_full where a = 12;")
    ...
    result = node_subscriber.safe_sql("SELECT a FROM tab_full where a IN (21,22);")
    ...
    node_publisher.safe_sql("INSERT INTO tab_copy SELECT generate_series(1,5);")
    ...
    # Setup logical replication
    node_publisher.safe_sql("CREATE PUBLICATION tap_pub_copy FOR TABLE tab_copy;")
    ...
    node_subscriber.safe_sql("ALTER SUBSCRIPTION tap_sub_copy SET (two_phase = false);")
