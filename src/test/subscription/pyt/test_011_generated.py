...
"""
    ...
    result = node_subscriber.safe_sql("SELECT a, b FROM tab_gen_to_nogen ORDER BY a")
    assert (
        result == "1|\n2|\n3|"
    ...
    node_subscriber.safe_sql("DROP table tab_gen_to_nogen", dbname="test_pgc_true")
    ...
    assert result == "|2\n|4", "tab2 initial sync, when publish_generated_columns=none"
