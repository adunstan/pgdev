...
def test_035_conflicts(create_pg):
    ...
    node_publisher.safe_sql("CREATE PUBLICATION pub_tab FOR TABLE conf_tab, conf_tab_2")
    ...
    node_subscriber.safe_sql("INSERT INTO conf_tab VALUES (2,2,2), (3,3,3), (4,4,4);")
    ...
    # Insert data in the subscriber table
    node_subscriber.safe_sql("INSERT INTO conf_tab VALUES (6,6,6), (7,7,7), (8,8,8);")
    ...
    stderr = psql_stderr(node_A, f"ALTER SUBSCRIPTION {subname_AB} SET (origin = any);")
    assert re.search(
    ...
    if injection_points_supported:
        ...
        sub_ts = node_A.safe_sql("SELECT timestamp FROM pg_last_committed_xact();")
    ...
    node_B.safe_sql("SELECT * FROM pg_create_physical_replication_slot('blocker');")
