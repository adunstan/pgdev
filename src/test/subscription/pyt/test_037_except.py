...
def _test_except_root_partition(node_publisher, node_subscriber,
                                publisher_connstr, pubviaroot):
...
def test_037_except(create_pg):
    ...
    node_publisher.safe_sql(
        "INSERT INTO child VALUES(generate_series(11,20), "
    ...
    # to its child.
    node_publisher.safe_sql(
        "INSERT INTO child1 VALUES(generate_series(11,20), "
        "generate_series(11,20))")
    ...
    # false
    _test_except_root_partition(node_publisher, node_subscriber,
                                publisher_connstr, "false")
    _test_except_root_partition(node_publisher, node_subscriber,
                                publisher_connstr, "true")
