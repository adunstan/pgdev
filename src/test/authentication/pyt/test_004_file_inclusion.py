...
def test_004_file_inclusion(create_pg):
    ...
    hba_expected += add_hba_line(node, hba_file, "include_if_exists ../hba_inc_if/none")
    # File with some contents loaded.
    hba_expected += add_hba_line(node, hba_file, "include_if_exists ../hba_inc_if/some")
    ...
    # directory.
    ident_expected += add_ident_line(node, ident_file, "include ../pg_ident_pre.conf")
