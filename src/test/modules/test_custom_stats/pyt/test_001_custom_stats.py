...
def test_001_custom_stats(create_pg):
    ...
    _safe_sql_oneshot(node, "select test_custom_stats_var_create('entry1', 'Test entry 1')")
    _safe_sql_oneshot(node, "select test_custom_stats_var_create('entry2', 'Test entry 2')")
    _safe_sql_oneshot(node, "select test_custom_stats_var_create('entry3', 'Test entry 3')")
    _safe_sql_oneshot(node, "select test_custom_stats_var_create('entry4', 'Test entry 4')")
