...
def run_test(rewind, test_mode):
    ...
    append_to_file(
        ...
        "in standby2")
    append_to_file(
        os.path.join(test_standby_datadir, "tst_standby_dir",
                     "standby_file3 with 'quotes'"),
        "in standby3")
    os.mkdir(os.path.join(test_standby_datadir, "tst_standby_dir",
                          "standby_subdir"))
    append_to_file(
        os.path.join(test_standby_datadir, "tst_standby_dir", "standby_subdir",
                     "standby_file4"),
        "in standby4")
    ...
    os.mkdir(os.path.join(test_primary_datadir, "tst_primary_dir",
                          "primary_subdir"))
    append_to_file(
        os.path.join(test_primary_datadir, "tst_primary_dir", "primary_subdir",
                     "primary_file3"),
        "in primary3")
