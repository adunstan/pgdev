...
def test_nonesuch(create_pg):
    ...
    node.command_checks_all(
        ...
        1,
        [re.compile(r"^$")],
        [re.compile(r'pg_amcheck: error: no connectable databases to check matching "qqq"')],
    ...
    node.command_checks_all(
        ...
        [re.compile(r"^$")],
        [
            re.compile(r'pg_amcheck: warning: no heap tables to check matching "no_such_table"'),
            re.compile(r'pg_amcheck: warning: no heap tables to check matching "no\*such\*table"'),
            re.compile(r'pg_amcheck: warning: no btree indexes to check matching "no_such_index"'),
            re.compile(r'pg_amcheck: warning: no btree indexes to check matching "no\*such\*index"'),
            re.compile(r'pg_amcheck: warning: no relations to check matching "no_such_relation"'),
            re.compile(r'pg_amcheck: warning: no relations to check matching "no\*such\*relation"'),
            re.compile(r'pg_amcheck: warning: no heap tables to check matching "no\*such\*table"'),
            re.compile(r'pg_amcheck: warning: no connectable databases to check matching "no_such_database"'),
            re.compile(r'pg_amcheck: warning: no connectable databases to check matching "no\*such\*database"'),
            re.compile(r'pg_amcheck: warning: no relations to check matching "none\.none"'),
            re.compile(r'pg_amcheck: warning: no connectable databases to check matching "none\.none\.none"'),
            re.compile(r'pg_amcheck: warning: no relations to check matching "postgres\.none\.none"'),
            re.compile(r'pg_amcheck: warning: no relations to check matching "postgres\.pg_catalog\.none"'),
            re.compile(r'pg_amcheck: warning: no relations to check matching "postgres\.none\.pg_class"'),
            re.compile(r'pg_amcheck: warning: no connectable databases to check matching "no_such_database"'),
            re.compile(r'pg_amcheck: warning: no connectable databases to check matching "no\*such\*database"'),
            re.compile(r'pg_amcheck: warning: no connectable databases to check matching "none\.none\.none"'),
        ],
    ...
    node.command_checks_all(
        ...
        [re.compile(r"^$")],
        [
            re.compile(r'pg_amcheck: warning: skipping database "template1": amcheck is not installed'),
            re.compile(r'pg_amcheck: warning: no heap tables to check matching "template1\.public\.foo"'),
            re.compile(r'pg_amcheck: warning: no heap tables to check matching "another_db\.public\.foo"'),
            re.compile(r'pg_amcheck: warning: no connectable databases to check matching "no_such_database\.public\.foo"'),
            re.compile(r'pg_amcheck: warning: no btree indexes to check matching "template1\.public\.foo_idx"'),
            re.compile(r'pg_amcheck: warning: no btree indexes to check matching "another_db\.public\.foo_idx"'),
            re.compile(r'pg_amcheck: warning: no connectable databases to check matching "no_such_database\.public\.foo_idx"'),
            re.compile(r"pg_amcheck: error: no relations to check"),
        ],
