    ...
    return {
        ...
        "defaults_custom_format": {
            ...
            "command_like": {
                ...
                "expected": re.compile(
                    r"Compression: gzip" if supports_gzip else r"Compression: none"
                ),
    ...
    return {
        ...
        "ALTER TABLE test_table DISABLE TRIGGER ALL": {
            "regexp": _qr(
                ...
                \n(?:\d\t\\N\t\\N\t\\N\n){9}\\\.\n\n\n
                \QALTER TABLE dump_test.test_table ENABLE TRIGGER ALL;\E""",
                _XM,
            ),
            "like": {"data_only"},
        },
        ...
        "ALTER TABLE test_second_table OWNER TO": {
            "regexp": _qr(
                r"^\QALTER TABLE dump_test.test_second_table OWNER TO \E.+;", _M
            ),
            "like": full | dts | {"section_pre_data"},
            "unlike": {
                "exclude_dump_test_schema",
        ...
        "ALTER TABLE measurement_y2006m2 OWNER TO": {
            "regexp": _qr(
                r"^\QALTER TABLE dump_test_second_schema.measurement_y2006m2 OWNER TO \E.+;",
                _M,
            ),
            "like": full
            | {
        ...
        "ALTER FOREIGN TABLE foreign_table OWNER TO": {
            "regexp": _qr(
                r"^\QALTER FOREIGN TABLE dump_test.foreign_table OWNER TO \E.+;", _M
            ),
            "like": full | dts | {"section_pre_data"},
            "unlike": {
                "exclude_dump_test_schema",
        ...
        "ALTER TEXT SEARCH CONFIGURATION alt_ts_conf1 OWNER TO": {
            "regexp": _qr(
                r"^\QALTER TEXT SEARCH CONFIGURATION dump_test.alt_ts_conf1 OWNER TO \E.+;",
                _M,
            ),
            "like": full | dts | {"section_pre_data"},
            "unlike": {
        ...
        "ALTER TEXT SEARCH DICTIONARY alt_ts_dict1 OWNER TO": {
            "regexp": _qr(
                r"^\QALTER TEXT SEARCH DICTIONARY dump_test.alt_ts_dict1 OWNER TO \E.+;",
                _M,
            ),
            "like": full | dts | {"section_pre_data"},
            "unlike": {
...
def _tests_part2(full, dts):
    return {
        ...
        "COMMENT ON CONVERSION dump_test.test_conversion": {
            ...
            "regexp": _qr(
                r"^\QCOMMENT ON CONVERSION dump_test.test_conversion IS 'comment on test conversion';\E",
                _M,
            ),
            "like": full | dts | {"section_pre_data"},
            "unlike": {
        ...
        "COMMENT ON COLLATION test0": {
            ...
            "regexp": _qr(
                r"^\QCOMMENT ON COLLATION public.test0 IS 'comment on test0 collation';\E",
                _M,
            ),
            "collation": True,
            "like": full | {"section_pre_data"},
        ...
        "COMMENT ON TEXT SEARCH CONFIGURATION dump_test.alt_ts_conf1": {
            ...
            "regexp": _qr(
                r"^\QCOMMENT ON TEXT SEARCH CONFIGURATION dump_test.alt_ts_conf1 IS 'comment on text search configuration';\E",
                _M,
            ),
            "like": full | dts | {"section_pre_data"},
            "unlike": {
        ...
        "COMMENT ON TEXT SEARCH DICTIONARY dump_test.alt_ts_dict1": {
            ...
            "regexp": _qr(
                r"^\QCOMMENT ON TEXT SEARCH DICTIONARY dump_test.alt_ts_dict1 IS 'comment on text search dictionary';\E",
                _M,
            ),
            "like": full | dts | {"section_pre_data"},
            "unlike": {
        ...
        "COMMENT ON TEXT SEARCH PARSER dump_test.alt_ts_prs1": {
            ...
            "regexp": _qr(
                r"^\QCOMMENT ON TEXT SEARCH PARSER dump_test.alt_ts_prs1 IS 'comment on text search parser';\E",
                _M,
            ),
            "like": full | dts | {"section_pre_data"},
            "unlike": {
        ...
        "COMMENT ON TEXT SEARCH TEMPLATE dump_test.alt_ts_temp1": {
            ...
            "regexp": _qr(
                r"^\QCOMMENT ON TEXT SEARCH TEMPLATE dump_test.alt_ts_temp1 IS 'comment on text search template';\E",
                _M,
            ),
            "like": full | dts | {"section_pre_data"},
            "unlike": {
        ...
        "COMMENT ON TYPE dump_test.textrange - RANGE": {
            ...
            "regexp": _qr(
                r"^\QCOMMENT ON TYPE dump_test.textrange IS 'comment on range type';\E",
                _M,
            ),
            "like": full | dts | {"section_pre_data"},
            "unlike": {
        ...
        "COMMENT ON TYPE dump_test.int42 - Regular": {
            ...
            "regexp": _qr(
                r"^\QCOMMENT ON TYPE dump_test.int42 IS 'comment on regular type';\E",
                _M,
            ),
            "like": full | dts | {"section_pre_data"},
            "unlike": {
        ...
        "COMMENT ON TYPE dump_test.undefined - Undefined": {
            ...
            "regexp": _qr(
                r"^\QCOMMENT ON TYPE dump_test.undefined IS 'comment on undefined type';\E",
                _M,
            ),
            "like": full | dts | {"section_pre_data"},
            "unlike": {
        ...
        "INSERT INTO test_fifth_table": {
            "regexp": _qr(
                r"^\QINSERT INTO dump_test.test_fifth_table (col1, col2, col3, col4, col5) VALUES (NULL, true, false, B'11001', 'NaN');\E",
                _M,
            ),
            "like": {"column_inserts"},
        },
        "INSERT INTO test_table_identity": {
            "regexp": _qr(
                r"^\QINSERT INTO dump_test.test_table_identity (col1, col2) OVERRIDING SYSTEM VALUE VALUES (1, 'test');\E",
                _M,
            ),
            "like": {"column_inserts"},
        },
        ...
        "CREATE CONVERSION dump_test.test_conversion": {
            ...
            "regexp": _qr(
                r"^\QCREATE DEFAULT CONVERSION dump_test.test_conversion FOR 'LATIN1' TO 'UTF8' FROM iso8859_1_to_utf8;\E",
                _XM,
            ),
            "like": full | dts | {"section_pre_data"},
            "unlike": {
        ...
        "CREATE TEXT SEARCH CONFIGURATION dump_test.alt_ts_conf1": {
            ...
            "regexp": _qr(
                ...
                \s+\QPARSER = pg_catalog."default" );\E""",
                _XM,
            ),
            "like": full | dts | {"section_pre_data"},
            "unlike": {
        ...
        "Check ordering of a function that depends on a primary key": {
            ...
            "regexp": _qr(
                ...
                .*^
                \QCREATE FUNCTION dump_test.ordering_func\E""",
                _XMS,
            ),
            "like": full | dts | {"section_post_data"},
            "unlike": {
...
def _tests_part3(full, dts):
    return {
        ...
        "ALTER TABLE test_table_generated_child1": {
            "regexp": _qr(
                r"^\QALTER TABLE ONLY dump_test.test_table_generated_child1 ALTER COLUMN col2 \E",
                _M,
            ),
            "like": set(),
        },
        ...
        "ALTER VIEW test_view SET DEFAULT": {
            ...
            "regexp": _qr(
                r"""^
                \QALTER TABLE ONLY dump_test.test_view ALTER COLUMN col1 SET DEFAULT 1;\E""",
                _XM,
            ),
            "like": full | dts | {"section_pre_data"},
            "unlike": {
        ...
        "DROP FUNCTION dump_test.pltestlang_call_handler()": {
            "regexp": _qr(
                r"^DROP FUNCTION dump_test\.pltestlang_call_handler\(\);", _M
            ),
            "like": {"clean"},
        },
        ...
        "GRANT SELECT ON TABLE test_table": {
            ...
            "   TO regress_dump_test_role;",
            "regexp": _qr(
                r"^\QGRANT SELECT ON TABLE dump_test.test_table TO regress_dump_test_role;\E",
                _M,
            ),
            "like": full
            | dts
        ...
        "GRANT SELECT ON TABLE measurement": {
            ...
            "regexp": _qr(
                r"""^\QGRANT SELECT ON TABLE dump_test.measurement TO regress_dump_test_role;\E\n.*
                 ^\QGRANT SELECT(city_id) ON TABLE dump_test.measurement TO "regress_quoted  \"" role";\E""",
                _XMS,
            ),
            "like": full
            | dts
        ...
        "GRANT SELECT ON TABLE measurement_y2006m2": {
            ...
            "   TO regress_dump_test_role;",
            "regexp": _qr(
                r"^\QGRANT SELECT ON TABLE dump_test_second_schema.measurement_y2006m2 TO regress_dump_test_role;\E",
                _M,
            ),
            "like": full
            | {
        ...
        "GRANT SELECT (proname ...) ON TABLE pg_proc TO public": {
            ...
            "regexp": _qr(
                ...
                \QGRANT SELECT(proacl) ON TABLE pg_catalog.pg_proc TO PUBLIC;\E""",
                _XMS,
            ),
            "like": full | {"section_pre_data"},
            "unlike": {"no_privs"},
        ...
        "extended_statistics_import": {
            ...
            "regexp": _qr(
                r"""^
                \QSELECT * FROM pg_catalog.pg_restore_extended_stats(\E\s+""",
                _XM,
            ),
            "like": full
            | dts
...
def test_pg_dump(pg, tmp_path):
    ...
    node.command_fails_like(
        ...
        re.escape(
            "pg_dump: error: options --statistics and -s/--schema-only cannot be used together"
        ),
