    ...
    return {
        "compression_none_custom": {
            ...
            "dump_cmd": [
                ...
                "--format", "custom",
                "--compress", "none",
                "--file", f"{tempdir}/compression_none_custom.dump",
                "--statistics",
                "postgres",
            ],
            "restore_cmd": [
                "pg_restore",
                "--file", f"{tempdir}/compression_none_custom.sql",
                "--statistics",
        ...
        "compression_gzip_custom": {
            ...
            "dump_cmd": [
                ...
                "--format", "custom",
                "--compress", "1",
                "--file", f"{tempdir}/compression_gzip_custom.dump",
                "--statistics",
                "postgres",
            ],
            "restore_cmd": [
                "pg_restore",
                "--file", f"{tempdir}/compression_gzip_custom.sql",
                "--statistics",
        ...
        "compression_gzip_dir": {
            ...
            "dump_cmd": [
                ...
                "--format", "directory",
                "--compress", "gzip:1",
                "--file", f"{tempdir}/compression_gzip_dir",
                "--statistics",
                "postgres",
            ],
            ...
            "restore_cmd": [
                "pg_restore",
                "--jobs", "2",
                "--file", f"{tempdir}/compression_gzip_dir.sql",
                "--statistics",
        ...
        "compression_gzip_plain": {
            ...
            "dump_cmd": [
                ...
                "--format", "plain",
                "--compress", "1",
                "--file", f"{tempdir}/compression_gzip_plain.sql.gz",
                "--statistics",
                "postgres",
            ],
        ...
        "compression_lz4_custom": {
            ...
            "dump_cmd": [
                ...
                "--format", "custom",
                "--compress", "lz4",
                "--file", f"{tempdir}/compression_lz4_custom.dump",
                "--statistics",
                "postgres",
            ],
            "restore_cmd": [
                "pg_restore",
                "--file", f"{tempdir}/compression_lz4_custom.sql",
                "--statistics",
        ...
        "compression_lz4_dir": {
            ...
            "dump_cmd": [
                ...
                "--format", "directory",
                "--compress", "lz4:1",
                "--file", f"{tempdir}/compression_lz4_dir",
                "--statistics",
                "postgres",
            ],
            # Give coverage for manually-compressed TOC files during restore.
            ...
            "restore_cmd": [
                "pg_restore",
                "--jobs", "2",
                "--file", f"{tempdir}/compression_lz4_dir.sql",
                "--statistics",
        ...
        "compression_lz4_plain": {
            ...
            "dump_cmd": [
                ...
                "--format", "plain",
                "--compress", "lz4",
                "--file", f"{tempdir}/compression_lz4_plain.sql.lz4",
                "--statistics",
                "postgres",
            ],
            # Decompress the generated file to run through the tests.
        ...
        "compression_zstd_custom": {
            ...
            "dump_cmd": [
                ...
                "--format", "custom",
                "--compress", "zstd",
                "--file", f"{tempdir}/compression_zstd_custom.dump",
                "--statistics",
                "postgres",
            ],
            "restore_cmd": [
                "pg_restore",
                "--file", f"{tempdir}/compression_zstd_custom.sql",
                "--statistics",
        ...
        "compression_zstd_dir": {
            ...
            "dump_cmd": [
                ...
                "--format", "directory",
                "--compress", "zstd:1",
                "--file", f"{tempdir}/compression_zstd_dir",
                "--statistics",
                "postgres",
            ],
            # Give coverage for manually-compressed TOC files during restore.
            ...
            "restore_cmd": [
                "pg_restore",
                "--jobs", "2",
                "--file", f"{tempdir}/compression_zstd_dir.sql",
                "--statistics",
        ...
        "compression_zstd_plain": {
            ...
            "dump_cmd": [
                ...
                "--format", "plain",
                "--compress", "zstd:long",
                "--file", f"{tempdir}/compression_zstd_plain.sql.zst",
                "--statistics",
                "postgres",
            ],
            # Decompress the generated file to run through the tests.
            "compress_cmd": {
                ...
                "args": [
                    "-d", "-f",
                    f"{tempdir}/compression_zstd_plain.sql.zst", "-o",
...
def _tests():
    ...
    return {
        ...
        "LO create (using lo_from_bytea)": {
            ...
            "regexp": re.compile(r"^SELECT pg_catalog\.lo_create\('\d+'\);",
                                 re.MULTILINE),
            "like": set(full),
        },
