...
def _pgbench(node, opts, expected_ret, stdout_res, stderr_res, msg, scripts, tmp_path):
    ...
    node.pg_bin.command_checks_all(cmd, expected_ret, stdout_res, stderr_res, msg)
