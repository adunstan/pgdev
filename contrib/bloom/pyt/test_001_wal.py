...
def _test_index_replay(node_primary, node_standby, session_primary,
                       session_standby, test_name):
    ...
    assert primary_result == standby_result, \
...
"""
    ...
    _test_index_replay(node_primary, node_standby, session_primary,
                       session_standby, "initial")
    ...
    for i in range(1, 11):
        ...
        _test_index_replay(node_primary, node_standby, session_primary,
                           session_standby, f"delete {i}")
        node_primary.safe_sql("VACUUM tst;")
        _test_index_replay(node_primary, node_standby, session_primary,
                           session_standby, f"vacuum {i}")
